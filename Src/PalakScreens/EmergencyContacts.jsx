    ...
    async data => {
      try {
        ...
        if (isEditing && selectedContact) {
          ...
          savedContact = await FirestoreService.saveEmergencyContact(
            contactWithId,
          );
          setIsEditing(false);
        ...
        console.log(
          ...
          encodeURIComponent(savedContact?.id || 'unknown'),
        );
        await loadData();
        ...
        console.log('Error in palak:', error);
                      ...
                      render={({ field: { onChange, onBlur, value } }) => (
                        <TextInput
                          ...
                          left={
                            <TextInput.Icon
                              icon={() => (
                                <Icon name="phone" size={22} color="#1C75BC" />
                              )}
                            />
                          }
                          style={styles.modalPaperInput}
                    ...
                    <>
                      ...
                      <View style={styles.detailButtonContainer}>
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            handleCall(selectedContact.emergencyPhone)
                          }
                          activeOpacity={0.8}
                        >
                        ...
                        <TouchableOpacity
                          ...
                          onPress={async () => {
                            try {
                              const success =
                                await FirestoreService.deleteEmergencyContact(
                                  selectedContact.id,
                                );
                              if (success) {
                                await loadData();
