...
import ActivityCard from "./src/Screen/ActivityCard"
import { AnimatedCircularProgress } from 'react-native-circular-progress';
import StressInput from './src/Screen/StreeInput'
...
<Text style={{ marginTop: 20, fontSize: 20, marginLeft: 10, fontWeight: "bold" }}>service</Text>
     ...
     {/* doctor container */}
 <TouchableOpacity  style={{backgroundColor:'#d6f0fa',paddingLeft:10,flexDirection:'row',margin:10,
    ...
    borderLeftColor: '#0d6e9c',paddingVertical:55 }}>
      ...
      <Image
        source={require('./src/img/doc.png')}
        style={{  flex: 1,
        height: '230%',
        width:'170%',
        resizeMode: 'contain',
...
<Text style={{ marginTop: 20, fontSize: 20, marginLeft: 10, fontWeight: "bold" }}>Activity</Text>
        <ActivityCard/>
        <StressInput/>
</ScrollView>
